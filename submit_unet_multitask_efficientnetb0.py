...
if MODE == 'LOCAL':
    model_parameter_path = './submit_unet_multitask_efficientnetb0.pth'
...
checkpoint = torch.load('binary_classifier_unet_multitask_efficientnet_b0.pth', map_location=gpu)
